...
<body>
                                            ...
                                            ?>
                                                ...
                                                <tbody>
                                                    <tr data-id="1">
                                                        ...
                                                        <td></td>
                                                        <td style="width: 100px">
                                                            <button class="btn btn-primary w-sm waves-effect waves-light" onclick="openForm()">Enroll</button>
                                                        </td>
    ...
    <div class="form-popup" id="myForm">
        <form method="POST" action="book.php" ;>
            <div class="mb-3">
                <label class="form-label" for="customer"><b>Enter Your Name</b></label>
                <input type="text" name="customer" class="form-control" placeholder="Enter Your Name" required>
            </div>
            <div class="mb-3">
                <label class="form-label" for="days"><b>Course Name</b></label>
                <input type="text" name="days" class="form-control" placeholder="Enter Course Name" required>
            </div>
           <!--  <div class="mb-3">
                <label class="form-label" for="start"><b>Choose Start Date</b></label>
                <input type="date" name="start" class="form-control" placeholder="Choose Start Date" required>
            </div> -->
            <div class="mb-3">
            ...
            <div class="mt-3 text-end">
                <button class="btn btn-primary w-sm waves-effect waves-light" name="book" type="submit">Enroll Now</button>
            </div>
